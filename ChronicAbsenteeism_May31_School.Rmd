...
<center>
District 1245 = East Windsor  
District 1430 = Ewing   
District 1950 = Hamilton  
District 2280 = Hopewell  
District 2580 = Lawrence  
District 3105 = Mercer County Vocational  
District 4255 = Princeton  
District 5210 = Trenton  
District 5510 = Robbinsville  
District 5715 = Windsor-Plainsboro  
</center>
...
###Focusing on the bad schools in Mercer County, which districts are they in?
...
ggplot(poo2, aes(percentabsent, fill=factor(DistrictCode)))+
  ...
  theme(plot.title = element_text(hjust = 0.5))+
  theme(text=element_text(family="Times"))+
  scale_color_manual(values = c("#fffcb7", "#bebad9","#f98175","#b4dc6f","#fbcee5"))+
  scale_fill_manual(values = c("#fffcb7", "#bebad9","#f98175","#b4dc6f","#fbcee5"), name="District")
...
ggplot(poo3, aes(x=factor(DistrictCode),y=count,color=factor(DistrictCode),fill=factor(DistrictCode)))+
  ...
  theme(legend.position = "none")+
  theme(text=element_text(family="Times"))+
  scale_color_manual(values = c("#fbcee5", "#bebad9","#f98175","#b4dc6f","#fffcb7"))+
  scale_fill_manual(values = c("#fbcee5", "#bebad9","#f98175","#b4dc6f","#fffcb7"))
...
ggplot(poo3, aes(x=factor(DistrictCode),y=percent,color=factor(DistrictCode),fill=factor(DistrictCode)))+
  ...
  theme(legend.position = "none")+
  theme(text=element_text(family="Times"))+
  scale_color_manual(values = c("#fbcee5", "#f98175","#bebad9","#b4dc6f","#fffcb7"))+
  scale_fill_manual(values = c("#fbcee5", "#f98175","#bebad9","#b4dc6f","#fffcb7"))
```
\newpage
...
foo <- subset(foo, DistrictCode=="1245" & SchoolCode=="070" | 
                 ...
                 DistrictCode=="1950" & SchoolCode=="055" |
                 DistrictCode=="1950" & SchoolCode=="060" | 
                 DistrictCode=="1950" & SchoolCode=="210" |
                 DistrictCode=="1950" & SchoolCode=="225" | 
                 DistrictCode=="2280" & SchoolCode=="040" |
                 DistrictCode=="2280" & SchoolCode=="065" | 
                 DistrictCode=="2280" & SchoolCode=="075" |
                 DistrictCode=="2580" & SchoolCode=="080" |
                 DistrictCode=="2580" & SchoolCode=="100" | 
                 DistrictCode=="3105" & SchoolCode=="301" |
                 DistrictCode=="4255" & SchoolCode=="050" |
                 DistrictCode=="4255" & SchoolCode=="080" |
                 ...
                 DistrictCode=="5715" & SchoolCode=="040" |
                 DistrictCode=="5715" & SchoolCode=="140" |
                 DistrictCode=="5715" & SchoolCode=="150")

#label if schools is good or bad
foo$goodbad <- 1 #good
foo$goodbad[foo$DistrictCode=="1950" & foo$SchoolCode=="055" | 
              foo$DistrictCode=="1950" & foo$SchoolCode=="060" | 
              foo$DistrictCode=="4255" & foo$SchoolCode=="050" | 
              foo$DistrictCode=="5210" & foo$SchoolCode=="030" | 
              ...
              foo$DistrictCode=="5210" & foo$SchoolCode=="401"] <- 0
...
ggplot(foo2,aes(x=factor(group),y=meanpercent,color=factor(goodbad),fill=factor(goodbad)))+
  geom_bar(stat="identity", position ="dodge")+
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
...
ggplot(foo2,aes(x=factor(ethnic),y=meanpercent,color=factor(goodbad),fill=factor(goodbad)))+
  geom_bar(stat="identity", position ="dodge")+
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
...
foo$group[foo$HomeLanguage=="Haitian"] <- 8 
foo$group[foo$HomeLanguage=="Creoles and pidgins, French-based"] <- 9 
foo$group[foo$HomeLanguage=="Arabic"] <- 10 
foo$group[foo$HomeLanguage=="Chinese"] <- 11 
foo$group[foo$HomeLanguage=="Japanese"] <- 12 
foo$group[foo$HomeLanguage=="Polish"] <- 13 
foo$group[foo$HomeLanguage=="Russian"] <- 14 
foo$group[foo$HomeLanguage=="French"] <- 15 
foo$group[foo$HomeLanguage=="Korean"] <- 16 
foo$group[foo$HomeLanguage=="Italian"] <- 17 
foo$group[foo$HomeLanguage=="Hebrew"] <- 18 
foo$group[foo$HomeLanguage=="Tamil"] <- 19 
...
foo.g <- rbind(foo.g[1:8,],newrow2,foo.g[-(1:8),])
...
foo.b <- rbind(foo.b[1:4,],newrow2,foo.b[-(1:4),])
foo.b <- rbind(foo.b[1:5,],newrow3,foo.b[-(1:5),])
foo.b <- rbind(foo.b[1:6,],newrow4,foo.b[-(1:6),])
foo.b <- rbind(foo.b[1:9,],newrow5,foo.b[-(1:9),])
...
foo.b <- rbind(foo.b,newrow9)
foo.b <- rbind(foo.b,newrow10)
foo.b <- rbind(foo.b,newrow11)
foo.b <- rbind(foo.b,newrow12)

foofinal2 <- rbind(foo.b,foo.g)
foofinal2$goodbad <- 0
foofinal2$goodbad[20:38] <- 1

foofinal2$language <- "English" #english
foofinal2$language[foofinal2$group==2] <- "Other"
foofinal2$language[foofinal2$group==3] <- "Spanish" 
...
foofinal2$language[foofinal2$group==8] <- "Haitian" 
foofinal2$language[foofinal2$group==9] <- "Creoles and pidgins, French-based" 
foofinal2$language[foofinal2$group==10] <- "Arabic" 
foofinal2$language[foofinal2$group==11] <- "Chinese" 
foofinal2$language[foofinal2$group==12] <- "Japanese" 
foofinal2$language[foofinal2$group==13] <- "Polish" 
foofinal2$language[foofinal2$group==14] <- "Russian" 
foofinal2$language[foofinal2$group==15] <- "French" 
foofinal2$language[foofinal2$group==16] <- "Korean" 
foofinal2$language[foofinal2$group==17] <- "Italian" 
foofinal2$language[foofinal2$group==18] <- "Hebrew" 
foofinal2$language[foofinal2$group==19] <- "Tamil"
...
The two quartiles have same percentage of teacher attendance. Teachers overall don't miss a lot of school.
\newpage
