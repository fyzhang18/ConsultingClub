...
Student to staff ratio on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=TeacherRatio,y=percentabsent,color=factor(CountyCode),fill=factor(CountyCode)))+
  geom_point()+
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  ggtitle("Student to Teacher ratio per school")+
  labs(x = "Student:Teacher Ratio", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
pooNArm <- na.omit(poo.final)
ggplot(pooNArm,aes(x=AdministratorsRatio,y=percentabsent,color=factor(CountyCode),fill=factor(CountyCode)))+
  geom_point()+
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  ggtitle("Student to Administrators ratio per school")+
  labs(x = "Student:Staff Ratio", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Ethnicity on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
#PREPARE StudentToStaffRatios DF
#keeping columns: county code, district code, school code, teacher ratio, admin ratio
...
ggplot(pooNArm,aes(x=percent2,y=percentabsent,color=factor(ethnic),fill=factor(ethnic)))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  ggtitle("Teacher Avg Years Exp In School on chronic absenteeism")+
  labs(x = "Percent of ethnic group", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=percent2,y=percentabsent,color=factor(gender),fill=factor(gender)))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent of gender", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Student Group on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
#PREPARE StudentToStaffRatios DF
...
ggplot(pooNArm,aes(x=percent2,y=percentabsent,color=factor(group),fill=factor(group)))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent of student group", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ELA Literacy performance on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=ELAScore,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "ELA Score", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Math scores on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
###########################2. Math Scores
...
ggplot(pooNArm,aes(x=MathScore,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Math Score", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
English Language Proficiency Test on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=EngProfTest.Below,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent below proficiency (scored below 4.5)", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=PercentBelowProfBio,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent of students below Biology proficiency level", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Incidence on chronic absenteeism 
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=Violence,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of Violence Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=Vandalism,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of Vandalism Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=Weapons,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of Weapons Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=Substances,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of Substances Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=`Harassment, Intimidation, Bullying (HIB)`,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of HIB Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=`Total Unique Incidents`,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Number of Total Unique Incidents", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=`Incidents Per 100 Students Enrolled`,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Incidents Per 100 Students Enrolled", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Student suspension on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
#################3. English Language Proficiency Test
...
ggplot(pooNArm,aes(x=StudentSuspensionRate,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Student Suspension Rate", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Drop out rate on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
#################3. English Language Proficiency Test
...
ggplot(pooNArm,aes(x=SchoolRate,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Drop out Rate", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
Graduation rate on chronic absenteeism ** 
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=`School-Class of 2017: 4-Year Rate`,y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Class of 2017 Graduation Rate", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=EnrolledPercent, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent enrolled in postsecondary education by Fall after grad", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
SAT scores on chronic absenteeism*
```{r, echo=FALSE, warning=FALSE}
...
ggplot(pooNArm,aes(x=School_Avg, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "SAT Score", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=School_Avg, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "ACT Score", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
PSAT scores on chronic absenteeism
```{r, echo=FALSE, warning=FALSE}
poo <- `PSAT-SAT-ACTPerformance`[c(1:6)]
...
ggplot(pooNArm,aes(x=School_Avg, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "PSAT Score", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
#remove NA
pooNArm <- na.omit(poo.final)
ggplot(pooNArm,aes(x=TeacherAvgYearsExpInSchool,y=percentabsent,color=factor(CountyCode),fill=factor(CountyCode)))+
  geom_point()+
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  ggtitle("Teacher Avg Years Exp In School")+
  labs(x = "Teacher Avg Years Exp In School", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=HighestLevelEdPct, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Percent", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
...
ggplot(pooNArm,aes(x=lengthofday, y=percentabsent))+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
  labs(x = "Length of days (Hr:Mins)", y = "School chronic absenteeism rate")+
  theme(plot.title = element_text(face="bold", size=20, hjust=0))+
  theme(axis.title = element_text(face="bold", size=20))+ 
  theme(axis.text.x  = element_text(size=14),axis.text.y  = element_text(size=14))+
  theme(legend.text=element_text(size=14),legend.title=element_text(size=14))+
